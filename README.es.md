...
Pon las capturas en `public/shots/<key>.webp` (1582×991, solo la ventana del navegador) y completa `shot` en la variante correspondiente. Mientras tanto, cada hueco muestra un marcador con los colores de la variante.
