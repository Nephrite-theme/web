...
Pon las capturas en `public/shots/<key>.webp` (1600×1000) y completa `shot` en la variante correspondiente. Mientras tanto, cada hueco muestra un marcador con los colores de la variante.
