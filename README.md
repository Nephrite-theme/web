...
Place captures at `public/shots/<key>.webp` (1600×1000) and set `shot` on the matching variant. Until then, each slot shows a placeholder tinted with the variant's colors.
